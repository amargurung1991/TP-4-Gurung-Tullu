...
public class TRLApp {
	...
	public static void main(String[] args) {
		...
		System.out.println("Please enter from following options: \r1 for Checking book out \r2 for Checking book in \r3 for Help");
		...
		if(task == 1)//Checking book out 
		{
			...
			if(T1.checkHold().equals(""))// check for Hold in the database
			{
				...
				{	
					...
					System.out.println("Please 1 to enter another copy ID and 2 to exit");//whether to exit or check more copies out
		...
		if(task == 2)
		{
			...
			if(T1.checkHold().equals(""))// check for Hold in the database
			{
				...
				System.out.println(T1.checkCopyIn());
				System.out.println("Due Date: " + T1.returnDate());
